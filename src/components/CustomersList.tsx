  ...
  return (
    <div className="h-full card overflow-hidden flex flex-col">
      <div className="p-3 bg-slate-50 border-b">
        <h2 className="text-sm font-medium text-slate-700">Customers List</h2>
      </div>
        ...
        <table className="min-w-full divide-y divide-gray-200 text-xs">
          <thead className="bg-slate-50">
            <tr>
              ...
              <th className="px-3 py-2 text-left text-xs font-medium text-slate-500 uppercase tracking-wider">Location</th>
              ...
              <tr key={customer.id} className="hover:bg-slate-50">
                ...
                <td className="px-3 py-2 whitespace-nowrap">
                  <div className="flex items-center">
                    <div className={`w-2 h-2 rounded-full mr-1 ${getClusterColorClass(customer.cluster)}`}></div>
